...
const LoginPage = () => {
    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="relative z-10 w-full max-w-4xl mx-auto flex rounded-3xl overflow-hidden glass-panel border border-white/10 bg-bg-[#000814]/5 backdrop-blur-xl shadow-2xl">
                {/* ... rest of your code ... */}
